...
public class Car {
	...
	public void findCarList(double currentMileage,int engineSize,Car[] cars) {
		System.out.println("List of cars which have Mileage & engineSize more than given Mileage & engineSize");
		System.out.println();
		int flag=0;
		for(int i=0;i<10;i++) {
			if(cars[i].getCurrentMileage()>currentMileage && cars[i].getEngineSize()>engineSize) {
